...
- সব mutable variable-এর জন্য `let` ব্যবহার করো।
...
- Default variable `const` ব্যবহার করো।
    
- Mutable হলে `let` ব্যবহার করো।
    
- Immutable pattern বজায় রাখো, reassignment করা এড়াও।
...
- Variable declaration সবসময় ব্যবহার করার আগে করো।
    
- `let` এবং `const` use করে predictable block scope follow করো।
...
এই নোট দিয়ে তুমি `let` ও `const` সম্পূর্ণভাবে বুঝে যাবে, এবং practical JS coding-এ safe variable management করতে পারবে।

---

যদি চাও, আমি পরের টপিক হিসেবে **ES6 Hoisting, TDZ, Scope & Closure** সাজাতে পারি।  
